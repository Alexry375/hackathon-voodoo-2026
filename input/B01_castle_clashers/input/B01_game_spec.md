...
## Résumé exécutif
Ce titre est un jeu de tir balistique et de destruction physique 1v1. Le joueur doit défendre sa forteresse mobile (château bleu sur chenilles) contre une forteresse ennemie (rouge) et des menaces environnementales (corbeaux). Le gameplay repose sur l'exploitation des faiblesses structurelles de l'adversaire via des tirs ciblés, offrant une forte satisfaction visuelle grâce à la destruction dynamique des bâtiments.
...
1.  **Créer l'urgence (The Hook) :** Démarrer avec le château bleu tombant rapidement à 30% de vie à cause des corbeaux, affichant un curseur "main" animé invitant le joueur à agir immédiatement pour se sauver.
...
4.  **A/B Testing sur la condition de fin :** 
    ...
    *   *Scénario Fail :* Le joueur rate, les corbeaux détruisent son château -> Écran "Try Again" menant au store.
